    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "32px", fontFamily: "var(--font-sans)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: "32px", alignItems: "start" }}>
         ...
         <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
            ...
            <div style={{ background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "16px", padding: "32px", boxShadow: "0 1px 2px rgba(0,0,0,0.02)" }}>
               <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "32px" }}>
                 <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                    <div style={{ width: "40px", height: "40px", borderRadius: "10px", background: "#FFF6F0", display: "grid", placeItems: "center", color: "#F25C05" }}>
               ...
               <div style={{ marginBottom: "32px" }}>
                 <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "16px" }}>
                   ...
                   <div style={{ fontSize: "1.5rem", fontWeight: "800", color: "#F25C05" }}>{sensitivity}%</div>
                 </div>
                 <div style={{ position: "relative", height: "32px", display: "flex", alignItems: "center", marginBottom: "8px" }}>
                   ...
                   />
                   <div style={{ position: "absolute", width: `${sensitivity}%`, height: "4px", background: "#F25C05", borderRadius: "2px" }}></div>
                   <div style={{ position: "absolute", left: `calc(${sensitivity}% - 8px)`, width: "16px", height: "16px", background: "#F25C05", borderRadius: "50%", boxShadow: "0 0 0 4px #FFF6F0" }}></div>
                 </div>
               ...
               <div style={{ background: "#FFF6F0", border: "1px solid #FFEDD5", borderRadius: "8px", padding: "16px", display: "flex", gap: "12px", alignItems: "center" }}>
                 <div style={{ width: "24px", height: "24px", borderRadius: "50%", background: "#F25C05", color: "#FFF", display: "grid", placeItems: "center", fontWeight: "800", fontSize: "0.8rem", flexShrink: 0 }}>i</div>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
                 ...
                 <button style={{ background: "none", border: "none", color: "#F25C05", fontWeight: "700", fontSize: "0.9rem", cursor: "pointer" }}><span style={{ fontSize: "1.2rem", lineHeight: "1" }}>+</span> New Tier</button>
              </div>
              <div style={{ display: "flex", gap: "20px" }}>
                <div style={{ flex: 1, background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "12px", padding: "24px", display: "flex", flexDirection: "column", gap: "16px", boxShadow: "0 1px 2px rgba(0,0,0,0.02)" }}>
                   ...
                   <ul style={{ listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column", gap: "8px", fontSize: "0.85rem", color: "#475569", flex: 1 }}>
                     <li style={{ display: "flex", gap: "8px", alignItems: "center" }}><span style={{ color: "#F25C05" }}>✓</span> 5,000 leads</li>
                     <li style={{ display: "flex", gap: "8px", alignItems: "center" }}><span style={{ color: "#F25C05" }}>✓</span> Basic AI Agents</li>
                   </ul>
                ...
                <div style={{ flex: 1, background: "#F25C05", borderRadius: "12px", padding: "24px", display: "flex", flexDirection: "column", gap: "16px", color: "#FFF", position: "relative", overflow: "hidden" }}>
                   <div>
                   ...
                   <button style={{ width: "100%", padding: "10px", background: "#FFFFFF", border: "none", borderRadius: "8px", color: "#F25C05", fontWeight: "700", fontSize: "0.9rem", cursor: "pointer", zIndex: 10 }}>Manage Plan</button>
                ...
                <div style={{ flex: 1, background: "#F8FAFC", border: "1px dashed #CBD5E1", borderRadius: "12px", padding: "24px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "16px" }}>
                   ...
                   <button style={{ padding: "8px 16px", background: "#FFF6F0", border: "none", borderRadius: "8px", color: "#F25C05", fontWeight: "700", fontSize: "0.85rem", cursor: "pointer" }}>Configure</button>
                </div>
              </div>
            </div>
         </div>
         ...
         <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
            ...
            <div style={{ background: "#0F172A", borderRadius: "16px", padding: "32px", color: "#FFFFFF" }}>
               ...
               <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                 <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                   ...
                   <button onClick={() => setAuthToggle(!authToggle)} style={{ width: "44px", height: "24px", borderRadius: "12px", background: authToggle ? "#F25C05" : "#475569", border: "none", position: "relative", cursor: "pointer", transition: "background 0.2s" }}>
                 ...
                 <div>
                   ...
                   <div style={{ display: "flex", gap: "8px" }}>
                     ...
                     <button style={{ flex: 1, padding: "8px", background: "#F25C05", border: "none", borderRadius: "6px", color: "#FFFFFF", fontSize: "0.85rem", cursor: "pointer", fontWeight: "600" }}>1h</button>
               ...
               <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                 <div>
                   ...
                   <div style={{ width: "100%", height: "4px", background: "#F1F5F9", borderRadius: "2px" }}>
                     <div style={{ width: "99.9%", height: "100%", background: "#F25C05", borderRadius: "2px" }}></div>
                   </div>
                 </div>
                 <div>
                   <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px", fontSize: "0.75rem", fontWeight: "800", color: "#94A3B8", textTransform: "uppercase", letterSpacing: "0.05em" }}>
            ...
            <button style={{ width: "100%", padding: "16px", background: "#F25C05", border: "none", borderRadius: "12px", color: "#FFFFFF", display: "flex", gap: "8px", alignItems: "center", justifyContent: "center", fontSize: "1rem", fontWeight: "700", cursor: "pointer", boxShadow: "0 4px 12px rgba(242, 92, 5, 0.25)" }}>
