...
const NAV_ITEMS = [
  ...
  { href: "/agent/schedule", label: "Schedule", icon: "CalendarDays" },
];

const BOTTOM_NAV_ITEMS = [
  { href: "/agent/profile", label: "My Profile", icon: "Settings" },
];
...
export function AgentShell({
  ...
  const handleAvatarClick = useCallback(() => {
    router.push("/agent/profile" as any);
  }, [router]);

  let subtitle = "Lead Management";
  if (pathname === "/agent") subtitle = "Live Dashboard";
  if (pathname.includes("schedule")) subtitle = "Schedule";
  if (pathname.includes("profile")) subtitle = "Profile";
    ...
    <div className="crm-layout">
      ...
      <aside className="crm-sidebar">
        ...
        <div className="crm-sidebar-bottom">
          ...
          {/* Pro Plan Upsell Module - Removed from Agent View */}
