    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "32px", fontFamily: "var(--font-sans)" }}>
       ...
       <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
          <div style={{ background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "12px", padding: "24px", display: "flex", gap: "20px", alignItems: "center", boxShadow: "0 1px 3px rgba(0,0,0,0.02)" }}>
            <div style={{ width: "56px", height: "56px", borderRadius: "12px", background: "#FFF6F0", display: "grid", placeItems: "center", color: "#F25C05" }}>
       ...
       <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
           <div style={{ display: "flex", gap: "12px" }}>
             <select onChange={(e) => alert("Filtering by plan: " + e.target.value)} style={{ padding: "10px 16px", background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "8px", color: "#1E293B", fontWeight: "500", fontSize: "0.9rem", outline: "none", cursor: "pointer", appearance: "none", backgroundImage: "url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20width%3D%2212%22%20height%3D%2212%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%2364748B%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22M6%209l6%206%206-6%22%2F%3E%3C%2Fsvg%3E')", backgroundRepeat: "no-repeat", backgroundPosition: "right 16px center", paddingRight: "40px" }}>
               <option>All Plans</option>
               <option>Enterprise</option>
               <option>Professional</option>
             </select>
             <select onChange={(e) => alert("Filtering by status: " + e.target.value)} style={{ padding: "10px 16px", background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "8px", color: "#1E293B", fontWeight: "500", fontSize: "0.9rem", outline: "none", cursor: "pointer", appearance: "none", backgroundImage: "url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20width%3D%2212%22%20height%3D%2212%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%2364748B%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22M6%209l6%206%206-6%22%2F%3E%3C%2Fsvg%3E')", backgroundRepeat: "no-repeat", backgroundPosition: "right 16px center", paddingRight: "40px" }}>
               <option>All Status</option>
               <option>Active</option>
               <option>Pending</option>
             </select>
             <button onClick={() => alert("Sorting by date joined...")} style={{ display: "flex", alignItems: "center", gap: "8px", padding: "10px 16px", background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "8px", color: "#1E293B", fontWeight: "500", fontSize: "0.9rem", cursor: "pointer" }}>
          ...
          <button onClick={() => alert("Opening new agency registration form...")} style={{ display: "flex", alignItems: "center", gap: "8px", background: "#F25C05", border: "none", padding: "10px 20px", borderRadius: "8px", color: "#FFFFFF", fontWeight: "600", fontSize: "0.95rem", cursor: "pointer", boxShadow: "0 4px 12px rgba(242, 92, 5, 0.25)" }}>
       ...
       <div style={{ background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "12px", boxShadow: "0 1px 3px rgba(0,0,0,0.02)", overflow: "hidden" }}>
                  ...
                  <tr key={agency.id} style={{ borderBottom: "1px solid #F1F5F9", transition: "background 0.2s", cursor: isVanguard ? "pointer" : "default", background: "transparent" }}>
                    ...
                    <td style={{ padding: "20px 24px" }}>
                      <span style={{ 
                        ...
                        color: agency.plan === "ENTERPRISE" ? "#F25C05" : "#64748B"
                      }}>
                        {agency.plan}
                      </span>
                    </td>
                    ...
                    <td style={{ padding: "20px 24px" }}>
                       ...
                       <button onClick={() => alert("Opening agency action menu...")} style={{ background: "none", border: "none", cursor: "pointer", color: "#94A3B8" }}>
          ...
          <div style={{ padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid #E2E8F0" }}>
             ...
             <div style={{ display: "flex", gap: "4px" }}>
               <button onClick={() => alert("Navigating to previous page (disabled)")} style={{ width: "32px", height: "32px", border: "1px solid #E2E8F0", background: "#FFFFFF", borderRadius: "6px", display: "grid", placeItems: "center", color: "#94A3B8", cursor: "not-allowed" }}>&lsaquo;</button>
               <button onClick={() => alert("Already on page 1")} style={{ width: "32px", height: "32px", border: "none", background: "#F25C05", borderRadius: "6px", display: "grid", placeItems: "center", color: "#FFFFFF", fontWeight: "600", cursor: "default" }}>1</button>
               <button onClick={() => alert("Navigating to page 2...")} style={{ width: "32px", height: "32px", border: "none", background: "transparent", borderRadius: "6px", display: "grid", placeItems: "center", color: "#475569", fontWeight: "500", cursor: "pointer" }}>2</button>
               <button onClick={() => alert("Navigating to page 3...")} style={{ width: "32px", height: "32px", border: "none", background: "transparent", borderRadius: "6px", display: "grid", placeItems: "center", color: "#475569", fontWeight: "500", cursor: "pointer" }}>3</button>
               <span style={{ width: "32px", height: "32px", display: "grid", placeItems: "center", color: "#475569", fontWeight: "500" }}>...</span>
               <button onClick={() => alert("Navigating to page 128...")} style={{ width: "32px", height: "32px", border: "none", background: "transparent", borderRadius: "6px", display: "grid", placeItems: "center", color: "#475569", fontWeight: "500", cursor: "pointer" }}>128</button>
               <button onClick={() => alert("Navigating to next page...")} style={{ width: "32px", height: "32px", border: "1px solid #E2E8F0", background: "#FFFFFF", borderRadius: "6px", display: "grid", placeItems: "center", color: "#0F172A", cursor: "pointer" }}>&rsaquo;</button>
             </div>
          </div>
       </div>
