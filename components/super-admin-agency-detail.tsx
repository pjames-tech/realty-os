  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "32px", fontFamily: "var(--font-sans)" }}>
      ...
      <div style={{ display: "flex", gap: "12px", fontSize: "0.85rem", fontWeight: "600", color: "#94A3B8", alignItems: "center" }}>
        <Link href={"/super-admin" as Route} style={{ color: "#F25C05", textDecoration: "none" }}>Dashboard</Link>
        <span>/</span>
        <Link href={"/super-admin/agencies" as Route} style={{ color: "#F25C05", textDecoration: "none" }}>Agencies</Link>
        <span>/</span>
        ...
        <div style={{ display: "flex", gap: "24px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <span style={{ fontSize: "0.7rem", fontWeight: "800", padding: "4px 10px", background: "#FFF6F0", color: "#F25C05", borderRadius: "100px", textTransform: "uppercase", letterSpacing: "0.05em" }}>Active</span>
            </div>
            ...
            <div style={{ display: "flex", gap: "24px", marginTop: "4px", fontSize: "0.95rem", color: "#475569", fontWeight: "500" }}>
               <div style={{ display: "flex", gap: "8px", alignItems: "center" }}><span style={{ color: "#F25C05" }}>✉</span> contact@vanguard.re</div>
               <div style={{ display: "flex", gap: "8px", alignItems: "center" }}><span style={{ color: "#F25C05" }}>📞</span> +1 (212) 555-0198</div>
            </div>
          </div>
        </div>
        <div style={{ display: "flex", gap: "12px" }}>
          <button onClick={() => alert("Generating full CSV export of " + "Vanguard Realty Group")} style={{ display: "flex", alignItems: "center", gap: "8px", padding: "10px 20px", background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "8px", color: "#0F172A", fontWeight: "600", fontSize: "0.9rem", cursor: "pointer", boxShadow: "0 1px 2px rgba(0,0,0,0.05)" }}>
          ...
          <button onClick={() => prompt("Type 'CONFIRM' to suspend this agency's platform access.")} style={{ display: "flex", alignItems: "center", gap: "8px", background: "#EF4444", border: "none", padding: "10px 20px", borderRadius: "8px", color: "#FFFFFF", fontWeight: "600", fontSize: "0.9rem", cursor: "pointer", boxShadow: "0 4px 12px rgba(239, 68, 68, 0.25)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "20px" }}>
        ...
        <div style={{ background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "12px", padding: "24px", boxShadow: "0 1px 3px rgba(0,0,0,0.02)" }}>
           ...
           <div style={{ width: "100%", height: "4px", background: "#F1F5F9", borderRadius: "4px", overflow: "hidden" }}>
             <div style={{ width: "80%", height: "100%", background: "#F25C05" }}></div>
           </div>
        </div>
        ...
        <div style={{ background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "12px", padding: "24px", boxShadow: "0 1px 3px rgba(0,0,0,0.02)" }}>
           ...
           <div style={{ width: "100%", height: "4px", background: "#F1F5F9", borderRadius: "4px", overflow: "hidden" }}>
             <div style={{ width: "45%", height: "100%", background: "#F25C05" }}></div>
           </div>
        </div>
        ...
        <div style={{ background: "#0F172A", border: "1px solid #1E293B", borderRadius: "12px", padding: "24px", position: "relative", overflow: "hidden" }}>
           ...
           <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
             <span style={{ color: "#F25C05", fontWeight: "700", fontSize: "0.9rem" }}>Elite Tier</span>
        ...
        <div style={{ background: "#F25C05", borderRadius: "12px", padding: "24px", color: "#FFFFFF", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: "32px", alignItems: "start" }}>
         ...
         <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
              ...
              <button onClick={() => alert("Opening full agent roster...")} style={{ background: "none", border: "none", color: "#F25C05", fontWeight: "700", fontSize: "0.9rem", cursor: "pointer" }}>View All 142 Agents</button>
            </div>
              ...
              {[
                ...
                <div key={agent.name} style={{ background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "12px", padding: "20px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 1px 2px rgba(0,0,0,0.02)" }}>
                   ...
                   <div style={{ display: "flex", gap: "48px", alignItems: "center" }}>
                     ...
                     <button onClick={() => alert(`View isolated performance dashboard for ${agent.name}`)} style={{ width: "32px", height: "32px", border: "none", background: "#F1F5F9", borderRadius: "50%", color: "#64748B", display: "grid", placeItems: "center", cursor: "pointer", fontSize: "1.2rem", paddingBottom: "2px" }}>
                       &rsaquo;
                     </button>
                   </div>
                </div>
         ...
         <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
            <div>
              ...
              <div style={{ background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "12px", padding: "24px", boxShadow: "0 1px 2px rgba(0,0,0,0.02)", display: "flex", flexDirection: "column", gap: "24px" }}>
                 ...
                 <button onClick={() => alert("Accessing complete SOC-2 audit logs...")} style={{ width: "100%", padding: "12px", background: "#F8FAFC", border: "1px solid #E2E8F0", borderRadius: "8px", color: "#0F172A", fontWeight: "700", fontSize: "0.9rem", cursor: "pointer", marginTop: "8px", transition: "background 0.2s" }} onMouseOver={e=>e.currentTarget.style.background="#F1F5F9"} onMouseOut={e=>e.currentTarget.style.background="#F8FAFC"}>
                   View Security Audit Log
                 </button>
              </div>
            </div>

            <div style={{ background: "#F25C05", borderRadius: "12px", padding: "32px", color: "#FFFFFF", position: "relative", overflow: "hidden" }}>
              ...
              <button onClick={() => alert("Provisioning Multi-Currency infrastructure (Beta)...")} style={{ background: "#FFFFFF", color: "#F25C05", border: "none", padding: "12px 24px", borderRadius: "8px", fontWeight: "700", cursor: "pointer", position: "relative", zIndex: 10, boxShadow: "0 4px 14px rgba(0,0,0,0.1)", transition: "transform 0.15s" }} onMouseDown={e=>e.currentTarget.style.transform="scale(0.97)"} onMouseUp={e=>e.currentTarget.style.transform="scale(1)"} onMouseLeave={e=>e.currentTarget.style.transform="scale(1)"}>Enable Beta Module</button>
